线上地址：http://10.12.48.176:8088   admin/123456
swagger地址：http://10.12.48.176:8088/zhfb 密码账号：admin/123456
旧的前端线上地址：http://10.12.48.176:8085/ 密码账号：admin/Fxs!#%135
前端仓库名字：shzhfb-front; 分支v2
...
```bash
VITE_PROXY = [["/zhfb","http://10.12.48.176:8088/zhfb"],["/upload","http://localhost:3300/upload"]]
VITE_GLOB_DOMAIN_URL=http://localhost:8080/zhfb
```

> 说明：把`http://localhost:8080/zhfb` 换成自己地址，其他不用改。
